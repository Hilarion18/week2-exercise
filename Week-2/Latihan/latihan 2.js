...
function loketPelayan(nomorUrut === 1 || nomorUrut === 4 || nomorUrut === 7 || nomorUrut === 10 && <=12) {
  console.log('Layanan Loket A')
  return nomorUrut
} 
console.logif (nomorUrut === 2 || nomorUrut === 5 || nomorUrut === 8 ||| nomorUrut === 11){
  ...
  console.log('Tidak ada loket tersedia')
  return nomorUrut
}
